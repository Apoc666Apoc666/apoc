...
$router->get('/gallery', 'App\\Modules\\Gallery\\Controller@index');
$router->get('/gallery/upload', 'App\\Modules\\Gallery\\Controller@uploadForm');
$router->post('/gallery/upload', 'App\\Modules\\Gallery\\Controller@upload');
$router->get('/gallery/view', 'App\\Modules\\Gallery\\Controller@view');
$router->get('/gallery/thumb', 'App\\Modules\\Gallery\\Controller@thumb');
